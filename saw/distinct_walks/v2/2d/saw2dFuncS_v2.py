...
def saw2dAddStep(coordinate_list, num_branch):

# Functions to add a step to coordinate_list of 2d Self-Avoiding Walk
...
def saw2dDistinctWalks(walks_list):

# Function to obtain distinct 2d Self-Avoiding Walks of (n+1) steps from n steps
...
#    print(lenWalks)
    ...
    for i in range(lenWalks):
        ...
        for n in range(num_branch):
            walks_temp = saw2dAddStep(checked_walks, n)
