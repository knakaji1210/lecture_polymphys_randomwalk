# Scaling of end-to-end distance for 1d Self-Avoiding Walk 

import numpy as np
from math import *
import saw1dFuncS_v2 as saws
import saw1dFuncM_v2 as sawm
...
for n in range(N):
    ...
    result_list = sawm.saw1dCalcR(walks_list)
    R = result_list[1]
...
fig_title = "Scaling of $R$ for 1-d Self-Avoiding Walk"
...
savefile = "./png/selfAvoidingWalk_1d_scaling_R_N{0}.png".format(N)
