...
for n in range(N):
    num = num + 1
    num_list.append(num)
    numWalks = sawm.saw3dCountDistinctWalks(num)
...
fig_title = "Number of Distinct Walks for 3-d Self-Avoiding Walk"
...
savefile = "./png/selfAvoidingWalk_3d_scaling_totalNum_N{0}.png".format(N)
