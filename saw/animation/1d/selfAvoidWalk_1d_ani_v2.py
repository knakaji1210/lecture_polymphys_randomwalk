# Animation of 1d Self-Avoiding Walk
# matplotlibのanimationからanimatplotに置き換える試み（250223）

import numpy as np
import saw1dFunc_v2 as saw
...
x_list_steps_m, y_list_steps_m, x_front_m, y_front_m, x_end_m, y_end_m, num_step_list = saw.saw1dM(N,M)

fig_title = "1-dimensional Self-Avoiding Walk ($N$ = {0}, $M$ = {1})".format(N,M)
plot_lim = 1.5*N
...
savefile = "./gif/selfAvoidWalk_1d_N{0}_M{1}".format(N,M)
