...
log_list = np.logspace(1, 2.7, 10, base=10)
...
fig.text(0.6, 0.23, result_text1)
fig.text(0.6, 0.17, result_text2)

fig.savefig("./png/selfAvoidWalk_2d_square_scaling.png", dpi=300)
