# Scaling of number of total distinct walks for 1d Random Walk 

import numpy as np
from math import *
import rw1dFuncS4 as rws
...
fig_title = "Number of Distinct Walks for 1-d Random Walk"
...
savefile = "./png/randomWalk_1d_scaling_totalNum_N{0}.png".format(N)
