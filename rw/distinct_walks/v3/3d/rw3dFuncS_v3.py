...
# Function to obtain distinct 3d Random Walks of (n+1) steps from n steps
    ...
    export_file_x = "./data/distinctWalks_3d_N{0}_x.csv".format(file_num+1)  # 次のステップのcsvファイルの名前
    export_file_y = "./data/distinctWalks_3d_N{0}_y.csv".format(file_num+1)
    export_file_z = "./data/distinctWalks_3d_N{0}_z.csv".format(file_num+1)
