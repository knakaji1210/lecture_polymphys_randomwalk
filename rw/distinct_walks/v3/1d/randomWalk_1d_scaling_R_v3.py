# Scaling of end-to-end distance for 1d Random Walk 

import numpy as np
from math import *
import rw1dFuncM_v3 as rwm
...
x_list, y_list, r_list = rwm.rw1dCalcR(file_num)
print(x_list)
print(y_list)
print(r_list)
...
#    num = num + 1
#    num_list.append(num)
#    walks_list = rws.rw1dDistinctWalks(walks_list)
#    result_list = rwm.rw1dCalcR(walks_list)
#    R = result_list[1]
...
#savefile = "./png/randomWalk_1d_scaling_R_N{0}.png".format(N)
