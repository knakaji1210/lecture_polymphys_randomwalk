# Scaling of 3d Random Walk (all models)
...
fig_title = "Scaling of $R$ for 3-d Random Walk ({0})".format(model_title)
...
savefile = "./png/randomWalk_3d_{0}_scaling_R_N{1:.0f}M{2:.0f}.png".format(model_fname, ex, logM)
