...
result_text1 = "$R$ = sqrt(<r$^2$>) ~ N$^{{{:.3f}}}$".format(exponent)
result_text2 = "$M$ = 10$^{{{0:.0f}}}$, $T_{{comp}}$ = {1:.5f} s".format(logM, elapsed_time)
...
savefile = "./png/randomWalk_2d_square_scaling_N{0:.0f}M{1:.0f}.png".format(ex, logM)
