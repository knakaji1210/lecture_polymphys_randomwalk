# Scaling of 2d Random Walk (freely-jointed chain model)
...
fig_title = "Scaling of $R$ for 2-d Random Walk (freely-jointed chain model)"
...
savefile = "./png/randomWalk_2d_fjc_scaling_R_N{0:.0f}M{1:.0f}.png".format(ex, logM)
