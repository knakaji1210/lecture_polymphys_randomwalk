# Function to calculate properties of 2d Random Walk (triangular lattice model) (multiple run)

import numpy as np
import rw2dFuncS_triangle as rws
...
def rw2dFuncM(N, M):
    ...
    for m in range(M):
        if (m!=0 and m%100000 ==0):     # added to check the progress
            print(m)
        coordinate_list, result_list = rws.rw2dFuncS(N)
        r2 = result_list[0]
        r = result_list[1]
