...
import rw2dFunc_triangle_v2 as rw
...
ax1_title = "2D Random Walk (triangle) ($N$ = $10^{0:.0f}$, $M$ = $10^{1:.0f}$)".format(logN, logM)
...
savefile = "./png/randomWalk_2d_triangle_N{0:.0f}M{1:.0f}.png".format(logN, logM)
